...
![VCS Centralizado](../img/git/vcs-centralizado-bis.png)
...
![VCS Distribuido](../img/git/vcs-distribuido-bis.png)
...
![Staging Area](../img/git/git-staging-area-bis.png)
...
![Crear cuenta en GitHub](../img/git/github-signup.png)

##  Crear repositorio

![Crear un repositorio](../img/git/github-new-repo.png)
...
![Cambiar avatar en GitHub](../img/git/github-avatar.png)
...
![Resumen áreas GIT](../img/git/git-all-areas-estrecho-bis.png)
...
![GitHub New Collaborator](../img/git/github-new-collaborator.png)

## Crear organizaciones

- Podemos **crear organizaciones**.

![GitHub New Organization](../img/git/github-new-organization.png)
...
![Creative Commons BY SA](../img/git/cc-by-sa.png)

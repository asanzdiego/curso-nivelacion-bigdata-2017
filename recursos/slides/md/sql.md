...
![Tipos de datos](../img/sql/sql-01.png)
...
![Restricciones columna](../img/sql/sql-03.png)

## Restricciones tabla

- Se pueden especificar **restricciones sobre toda la tabla**:

![Restricciones tabla](../img/sql/sql-04.png)
...
![Ejemplo índices](../img/sql/sql-05.png)
...
![Funciones de Agregación](../img/sql/sql-07.png)
...
![Tabla clientes](../img/sql/sql-08.png)

## Tabla pedidos

- Tabla pedidos:

![Tabla pedidos](../img/sql/sql-09.png)
...
![Vista pedidos por cliente](../img/sql/sql-10.png)

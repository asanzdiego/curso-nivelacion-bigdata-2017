...
![Ejemplo procesamiento](../img/xml/xml-05.png)
...
![Código abrir XML](../img/xml/xml-06-bis.png)
...
![Código iterar XML](../img/xml/xml-08-bis.png)
...
![Código filtrar XML](../img/xml/xml-10-bis.png)
...
![Código iterar XML desde raíz](../img/xml/xml-12-bis.png)
...
![Código acceso indexado](../img/xml/xml-14-bis.png)
...
![Código ejemplo findAll()](../img/xml/xml-16-bis.png)
...
![Código ejemplo interfase()](../img/xml/xml-18-bis.png)
...
![Código ejemplo fromstring()](../img/xml/xml-20-bis.png)
...
![Código ejemplo modificar XML](../img/xml/xml-22-bis.png)
...
![Código ejemplo eliminar elementos](../img/xml/xml-24-bis.png)
...
![Código ejemplo crear XML](../img/xml/xml-26-bis.png)
...
![Código ejemplo añadir atributos](../img/xml/xml-28-bis.png)
...
![Código ejemplo añadir hijos](../img/xml/xml-30.png)
...
![Código ejemplo añadir hijos con lista](../img/xml/xml-31.png)
...
![Código ejemplo guardar XML](../img/xml/xml-32-bis.png)
...
![Código ejemplo elementos vacíos I](../img/xml/xml-34-bis.png)

## Ejemplo elementos vacios (II)

![Código ejemplo elementos vacíos II](../img/xml/xml-36.png)

## Ejemplo elementos vacios (III)

![Código ejemplo elementos vacíos III](../img/xml/xml-37.png)

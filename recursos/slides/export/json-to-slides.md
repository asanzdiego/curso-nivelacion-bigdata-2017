...
![Ejemplo JSON](../img/json/json-01.png){ width=50% text-align=center }
...
![Ejemplo JSON](../img/json/json-02.png){ width=50% text-align=center }
...
![Cargar JSON](../img/json/json-03.png){ width=50% text-align=center }
...
![Escribir JSON](../img/json/json-05.png){ width=50% text-align=center }
...
![Ejemplo 1 - recoger JSON](../img/json/json-07.png){ width=50% text-align=center }
...
![Ejemplo 1 - procesar JSON](../img/json/json-08.png){ width=50% text-align=center }


## Ejemplos 1

![Ejemplo 1 - completo](../img/json/json-09.png){ width=50% text-align=center }
...
![Ejemplo 2 - autenticarse en twitter](../img/json/json-11.png){ width=50% text-align=center }
...
![Ejemplo 2 - dentro de apps de twitter](../img/json/json-12.png){ width=50% text-align=center }
...
![Ejemplo 2 - dentro de apps de twitter](../img/json/json-13.png){ width=50% text-align=center }
...
![Ejemplo 2 - información de apps de twitter](../img/json/json-14.png){ width=50% text-align=center }
...
![Ejemplo 2 - crear access token de twitter](../img/json/json-15.png){ width=50% text-align=center }
...
![Ejemplo 2 - valores app de twitter](../img/json/json-16.png){ width=50% text-align=center }
...
![Ejemplo 2 - hidden.py](../img/json/json-17.png){ width=50% text-align=center }
...
![Ejemplo 2 - twurl.py](../img/json/json-18.png){ width=50% text-align=center }
...
![Ejemplo 2 - twitter.py](../img/json/json-19.png){ width=50% text-align=center }
